        ...
        while (count_x < num_x):
            ...
            if(re.findall("^([0-9A-Fa-f]+):(0[0-9][0-9]|1[0-1][0-9]|12[0-7]|[0-9][0-9])$", text_x[count_x])):
                ...
                text_x[count_x] = re.sub(
                    "^([0-9A-Fa-f]+):(0[0-9][0-9]|1[0-1][0-9]|12[0-7]|[0-9][0-9])$", "\\1", text_x[count_x])
            ...
            if(re.findall("(000[0-9]|00[1-9][0-9]|01[0-9][0-9]|02[0-9][0-9]|03[0-6][0-9]|037[0-7])(000[0-9]|00[1-9][0-9]|01[0-9][0-9]|02[0-9][0-9]|03[0-6][0-9]|037[0-7])(000[0-9]|00[1-9][0-9]|01[0-9][0-9]|02[0-9][0-9]|03[0-6][0-9]|037[0-7])", text_x[count_x]) and pixeldone == False):
                color_matches = re.findall(
                    "(000[0-9]|00[1-9][0-9]|01[0-9][0-9]|02[0-9][0-9]|03[0-6][0-9]|037[0-7])(000[0-9]|00[1-9][0-9]|01[0-9][0-9]|02[0-9][0-9]|03[0-6][0-9]|037[0-7])(000[0-9]|00[1-9][0-9]|01[0-9][0-9]|02[0-9][0-9]|03[0-6][0-9]|037[0-7])", text_x[count_x])
                color_matches = color_matches[0]
                color_matches = [int(i) for i in color_matches]
                txt_img.line((count_x, count_y, count_x, count_y), fill=(int(color_matches[0], 8), int(
                    color_matches[1], 8), int(color_matches[2], 8), Transparency))
                pixeldone = True
            if(re.findall("(00[0-9]|0[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(00[0-9]|0[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(00[0-9]|0[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])", text_x[count_x]) and pixeldone == False):
                color_matches = re.findall(
                    "(00[0-9]|0[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(00[0-9]|0[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(00[0-9]|0[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])", text_x[count_x])
                color_matches = color_matches[0]
                color_matches = [int(i) for i in color_matches]
                txt_img.line((count_x, count_y, count_x, count_y), fill=(
            ...
            if(re.findall("([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})", text_x[count_x]) and pixeldone == False):
                color_matches = re.findall(
                    "([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})", text_x[count_x])
                color_matches = color_matches[0]
                txt_img.line((count_x, count_y, count_x, count_y), fill=(int(color_matches[0], 16), int(
                    color_matches[1], 16), int(color_matches[2], 16), Transparency))
                pixeldone = True
            count_x = count_x + 1
        count_y = count_y + 1
